...
**Shipped**
- Re-read full tree + key files (README, server.mjs, public/app.js, public/operator-extra.js, public/brain.html, data/seed.json, docs/*).
...
- No code change this run. No deploy. No Brain write.
